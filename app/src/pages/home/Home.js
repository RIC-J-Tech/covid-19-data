...
import {
  getBusinessesByBusinessName,
  getTopBusinesses,
} from "../../shared/actions/get-businesses";
...
export const Home = () => {
  ...
  const filterBusiness = businessState.filter(
    (businesses) =>
      businesses.businessName.toLowerCase().includes(searchWord) ||
      businesses.businessUrl.toLowerCase().includes(searchWord)
  );
  ...
  return (
    <main className="container">
      <div className="container-fluid" style={{ margin: "auto", width: "200" }}>
        <div style={{ marginLeft: 175 }}>
          <h1>
            <img src="PANOPS-LOGO.png"></img>
          </h1>
        </div>
