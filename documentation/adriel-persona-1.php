...
<body>
	<h1>Persona: Adriel Stephens; COVID 19 app user</h1>
		...
		<h2>Goals</h2>
			<p>To be informed about the current infection rate of COVID 19 around him.</p>
		<h2>Technology</h2>
			<ul>
				<li>Phone: Iphone 11</li>
		...
		<h2>Frustrations</h2>
			<p>
				Unable to get information about the measures taken by buisnesses to reduce the spread of the disease
				while running.
			</p>

	<h1>User Story</h1>
		<p>
			As a resident of the Sandoval county in New Mexico and a concerned citizen,
			I want to know what innovative methods and approaches buisnesses have adopted amidst this corona virus
			pandemic in order to keep their buisnesses running while following the stated safety guidelines.
		</p>
