...
//		$pdoReport = $reports[$i];
//		self::assertGreaterThan(getMinDate(), pdoReport->reportDate);
//    self::assertLessThan(getMaxDate(), pdoReport->reportDate);
}
...
private function getTestDate($interval): \DateTime {
