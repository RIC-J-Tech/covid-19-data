...
$yelpToken = "BeTB610CyxiZ-SStxTtSt_nYAzA6klchNLCS2L7SOFkFgm6IDBzn-B5ughcz9tWj6YuKEcfubmE3j3lTqvUT7JldOALNs1pXzasCNw0Qg1pFkKPCKX0mJmgMfKGxXnYx";
$authorization = "Authorization: Bearer " . $yelpToken;
...
for($offset = 0; $offset < 100; $offset = $offset + 20) {
	...
	foreach($businesses as $business) {
		...
		echo "<br>";
		$bus = new Business(generateUuidV4()->toString(), $business->image_url, $business->id, $business->coordinates->longitude, $business->coordinates->latitude, $business->name, $business->url);
		$bus->insert($pdo);
	}
}
