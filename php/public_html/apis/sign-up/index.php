...
try {
	...
	if($method === "POST") {
		...
		$message = <<< EOF
<h2>Welcome to Pan-Ops.</h2>
<p>In order to start posting behaviors you witness you must first confirm your account </p>
...
EOF;
		...
		$swiftMessage->setFrom(["gavrieljonah@gmail.com" => "Opeyemi Jonah"]);
